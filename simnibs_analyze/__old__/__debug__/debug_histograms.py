...
# ── Chemins ─────────────────────────────────────────────────────────────────
RESULTS_DIR = Path(
    "/Users/hippolyte.dreyfus/Desktop/hemianotACS/Data/derivatives/simnibs-config-healthyV2/results-V2"
)
DEBUG_PNG = RESULTS_DIR / "preprocess" / "debug_test.png"

BASE = Path(
    "/Users/hippolyte.dreyfus/Desktop/hemianotACS/Data/derivatives/simnibs-config-healthyV2"
)
SUBJECT = "0001"
...
SIM_DIR = (
    BASE
    / SUBJECT
    / "simulations/simulation_simulation_fef_hemianotacs_bc8ae6ee/mni_volumes"
)
